...
import 'package:google_maps_flutter/src/my_method_channel_google_maps_flutter.dart';
...
abstract class MyGoogleMapsFlutterPlatform extends PlatformInterface {
  /// Constructs a GoogleMapsFlutterPlatform.
  MyGoogleMapsFlutterPlatform() : super(token: _token);

  static final Object _token = Object();

  static MyGoogleMapsFlutterPlatform _instance =
      MyMethodChannelGoogleMapsFlutter();

  /// The default instance of [MyGoogleMapsFlutterPlatform] to use.
  ///
  /// Defaults to [MethodChannelGoogleMapsFlutter].
  static MyGoogleMapsFlutterPlatform get instance => _instance;

  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [GoogleMapsFlutterPlatform] when they register themselves.
  static set instance(MyGoogleMapsFlutterPlatform instance) {
