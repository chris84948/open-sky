...
final MyGoogleMapsFlutterPlatform _googleMapsFlutterPlatform =
    MyGoogleMapsFlutterPlatform.instance;
...
class GoogleMapController {
  ...
  MethodChannel get channel {
    if (_googleMapsFlutterPlatform is MyMethodChannelGoogleMapsFlutter) {
      return (_googleMapsFlutterPlatform as MyMethodChannelGoogleMapsFlutter)
          .channel(mapId);
    }
    return null;
  }
